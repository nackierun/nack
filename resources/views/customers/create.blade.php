            ...
            <div class="col-6">
                <ul>
                    ...
                    @foreach ($activecustomers as $activecustomers)
                        <li> {{ $activecustomers->name }} <span class="text-muted">({{ $activecustomers->company->name }})</span>
                        </li>
            ...
            <div class="col-6">
                <ul>
                    ...
                    @foreach ($inactivecustomers as $inactivecustomers)
                        <li> {{ $inactivecustomers->name }} <span class="text-muted">({{ $inactivecustomers->company->name }})</span>
                        </li>
